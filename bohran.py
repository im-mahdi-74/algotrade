...
def sod_sang(tickit_one_one, tickit_one_tow, tickit_tow_one, tickit_tow_tow):
    ...
    while True:
        ...
        if 8 < now.hour < 24 or   len(mt5.positions_get()) == 4 :
            ...
            if init_balance_one:
                ...
                if positions_one_one and positions_one_tow:
                    ...
                    if balance_one > 40  or balance_one < 0 :
                        print(balance_one)
                    if balance_one > 120 and init_balance_one:
            ...
            if init_balance_tow:
                ...
                if positions_tow_one and positions_tow_tow:
                    ...
                    if balance_tow > 40 or balance_tow < 0:
                        print(balance_tow)
                    if balance_tow > 120 and init_balance_tow :
...
def bohran():
    ...
    while True:
        ...
        if eq < 1050 :
            ...
            buy('GBPUSD_o', 1.3 , 0 , 0 , 'one')
            time.sleep(0.2)
            sell('EURUSD_o',  1.5 , 0 , 0 , 'one')
