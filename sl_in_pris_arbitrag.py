...
def trade():
    while True:
        try:
            if len(mt5.position_get()) == 0 or len(mt5.position_get()) == 3:
                one_gbp = buy('GBPUSD_o' , 0.01 , 0.05 , 0.05 , 'GBPUSD')
                tow_gbp = sell('GBPUSD_o' , 0.02 , 0.05 , 0.05 , 'GBPUSD')

                tow_eur = buy('EURUSD_o' , 0.02 , 0.05 , 0.05 , 'EURUSD')
                one_eur_gbp = sell('EURUSD_o' , 0.01 , 0.05 , 0.05 , 'EURUSD_o')

                one_eur = buy('EURGBP_o' , 0.01 , 0.05 , 0.05 , 'EURGBP_o')                
                tow_eur_gbp = sell('EURGBP' , 0.02 , 0.05 , 0.05 , 'EURGBP')
