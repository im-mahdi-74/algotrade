    ...
    while True:
        ...
        if init_balance_one:
            ...
            if positions_one_one and positions_one_tow:
                ...
                if balance_one > 10 :
                    print(balance_one)
                if balance_one > 20 and init_balance_tow and init_balance_one:
        ...
        if init_balance_tow:
            ...
            if positions_tow_one and positions_tow_tow:
                ...
                if balance_tow > 10 :
                    print(balance_tow)
                if balance_tow > 20 and init_balance_tow and init_balance_one:
...
def run_one():
    ...
    tickit_one_one =  buy('GBPUSD_o', 0.42 , 0 , 0 , 'propiy')
    tickit_one_tow =  sell('EURUSD_o', 0.5 , 0 , 0 , 'propiy')
...
def run_tow():
    ...
    tickit_tow_one =  sell('GBPUSD_o', 0.42  , 0 , 0 , 'propiy')
    tickit_tow_tow =  buy('EURUSD_o', 0.5 , 0 , 0 , 'propiy')
