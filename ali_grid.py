...
def run():
    ...
    if 0 < now.hour < 24   :
        try:
            ...
            tickit_one_one =  buy('GBPUSD', 0.09 , 0 , 0 , 'one')
            tickit_one_tow =  sell('EURUSD', 0.1 , 0 , 0 , 'one')
            tickit_tow_one =  sell('GBPUSD', 0.09 , 0 , 0 , 'tow')
            tickit_tow_tow =  buy('EURUSD', 0.1 ,  0 , 0 , 'tow')
